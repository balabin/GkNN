...
summary = '''
File: Run_kNN_arithm.py
Project: QSAR
Date: July 2018
Author: Ilya Balabin <balabin@gmail.com>
Purpose: Run evaluation of kNN model with arithmetic averaging
Dependencies: IOCommon, Fingerprints, kNN_arithm
'''
...
from kNN_arithm import *

# main parser
parser = argparse.ArgumentParser(description='Run the kNN_arithm model')
...
if __name__ == '__main__':
    ...
    # running kNN model with arithmetic averaging
    ...
    PrintTable(results)
    t2 = time.time()
    print >> sys.stderr, "Performed kNN_arithm-based evaluation in %f seconds" % (t2-t1)
