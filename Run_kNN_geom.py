...
summary = '''
File: Run_kNN_geom.py
Project: QSAR
Date: July 2018
Author: Ilya Balabin <balabin@gmail.com>
Purpose: Run evaluation of kNN model with geometric averaging
Dependencies: IOCommon, Fingerprints, kNN_geom
'''
...
from kNN_geom import *

# main parser
parser = argparse.ArgumentParser(description='Run the kNN_geom model')
...
if __name__ == '__main__':
    ...
    # running kNN model with geometric averaging
    ...
    PrintTable(results)
    t2 = time.time()
    print >> sys.stderr, "Performed kNN_geom-based evaluation in %f seconds" % (t2-t1)
